...
<#macro renderStat stats name description class=""><#assign value = stats.get(name)!"N/A"><#if (value != "0")><span class="class org.apache.maven.project.MavenProject">${description} ${value}</span><#else>${description} ${value}</#if></#macro>
...
<td><#list filesByFormat.keySet() as format><#assign file = filesByFormat.get(format)><a href="pom.xml">${format}</a><#if format_has_next>|</#if></#list></td>
</tr>
</#list>
</table>
<br />
